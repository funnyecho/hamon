    ...
    test(
        closureName(
            ...
            [
                ...
                'all listener was called in queue immediately with args',
...
describe('AsyncParallelBailHook with hashcode', () => {
    test(
        closureName(
            ['create AsyncParallelBailHook with hashcode function', 'invoke hook with args'],
